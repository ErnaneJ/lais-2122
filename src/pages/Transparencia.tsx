            ...
            <div className="flex flex-col rounded-lg shadow-md bg-eb_gray-200 p-8">
              ...
              <div className="w-full flex flex-wrap items-center justify-center">
                <div className="w-full mb-5 flex-col lg:w-1/4 flex items-center justify-center">
                  ...
                  <strong className="text-3xl text-eb_green mt-2">{Intl.NumberFormat('pt-BR').format(transparencia.dados_gerais.usuarios_registrados)}</strong>
                </div>
                <div className="w-full mb-5 flex-col lg:w-1/4 flex items-center justify-center">
                  <span className="flex items-center justify-center gap-2 font-semibold">
                  ...
                  <strong className="text-3xl text-eb_green mt-2">{Intl.NumberFormat('pt-BR').format(transparencia.dados_gerais.incricoes_realizadas)}</strong>
                </div>
                <div className="w-full mb-5 flex-col lg:w-1/4 flex items-center justify-center">
                  <span className="flex items-center justify-center gap-2 font-semibold">
                  ...
                  <strong className="text-3xl text-eb_green mt-2">{Intl.NumberFormat('pt-BR').format(transparencia.dados_gerais.cursos_ativos)}</strong>
                </div>
                <div className="w-full mb-5 flex-col lg:w-1/4 flex items-center justify-center">
                  <span className="flex items-center justify-center gap-2 font-semibold">
                  ...
                  <strong className="text-3xl text-eb_green mt-2">{Intl.NumberFormat('pt-BR').format(transparencia.dados_gerais.direito_certificacao)}</strong>
                </div>
                <div className="w-full mb-5 flex-col lg:w-1/3 flex items-center justify-center">
                  ...
                  <strong className="text-3xl text-eb_green mt-2">{transparencia.dados_gerais.investimento_medio_curso}</strong>
                </div>
                <div className="w-full mb-5 flex-col lg:w-1/3 flex items-center justify-center">
                  <span className="flex items-center justify-center gap-2 font-semibold">
                    <svg xmlns="http://www.w3.org/2000/svg" width="19" height="20" viewBox="0 0 19 20" fill="none">
                  ...
                  <strong className="text-3xl text-eb_green mt-2">{transparencia.dados_gerais.investimento_medio_aluno}</strong>
                </div>
              </div>
            </div>
          </div>
