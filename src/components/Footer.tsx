...
export const Footer = () => {
  return <footer className="text-white bg-eb_gray body-font">
    ...
    <div className="container pt-24 pb-21 mx-auto flex items-start justify-end">
    ...
    <div className="bg-eb_gray bg-opacity-75">
      <p className="text-gray-400 text-sm text-center w-full pb-5">
